...
class InstructorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create instructor" do
    assert_difference('Instructor.count') do
      post instructors_url, params: { instructor: { active: @instructor.active, bio: @instructor.bio, email: @instructor.email, first_name: @instructor.first_name, last_name: @instructor.last_name, phone: @instructor.phone } }
    end
  ...
  test "should update instructor" do
    patch instructor_url(@instructor), params: { instructor: { active: @instructor.active, bio: @instructor.bio, email: @instructor.email, first_name: @instructor.first_name, last_name: @instructor.last_name, phone: @instructor.phone } }
